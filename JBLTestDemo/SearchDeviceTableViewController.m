...
//  Copyright © 2017 徐正权. All rights reserved.
//
...
- (void)viewDidLoad {
    [super viewDidLoad];
    _searchIndictorView = [[UIActivityIndicatorView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2.0f, SCREEN_HEIGHT/2.0f, 10, 10)];
